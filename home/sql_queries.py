...
songplay_table_create = ("CREATE TABLE IF NOT EXISTS songplays (songplay_id varchar NOT NULL, start_time timestamp, user_id varchar, level varchar, song_id varchar, artist_id varchar, session_id varchar, location varchar, user_agent varchar);")

user_table_create = ("CREATE TABLE IF NOT EXISTS users (user_id varchar PRIMARY KEY NOT NULL, first_name varchar NOT NULL, last_name varchar, gender varchar, level varchar);")

artist_table_create = ("CREATE TABLE IF NOT EXISTS artists (artist_id varchar PRIMARY KEY NOT NULL, name varchar, location varchar, latitude float8, longitude float8);") 

song_table_create = ("CREATE TABLE IF NOT EXISTS songs (song_id varchar PRIMARY KEY NOT NULL, title varchar, artist_id varchar, year int, duration float8);")
